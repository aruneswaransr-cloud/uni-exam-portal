/*
# Add answered count and total questions to get_results

## Purpose
- Include how many questions each participant answered in the results output.
- Include the total number of questions in the quiz.

## Changes
- `get_results` now returns `answered_count` (count of responses for the attempt)
  and `total_questions` (count of questions in the quiz) per participant.

## Data safety
- No schema changes. Only the function definition is updated.
*/
